...
// Importe o Link para navegar para a página de cadastro
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            {/* O Link aponta para /register, como no seu AuthLinks.jsx */}
            <Link to="/register" className="font-medium text-primary hover:text-pink-500">
              Cadastre-se aqui
            </Link>
          </p>
        </div>
